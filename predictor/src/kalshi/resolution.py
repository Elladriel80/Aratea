...
NWS_STATIONS: dict[str, NWSStation] = {
    ...
    "CLIHOU":  NWSStation("CLIHOU",  "KHOU",  "Houston Hobby",            29.6454, -95.2789, "hgx"),
    "CLIDFW":  NWSStation("CLIDFW",  "KDFW",  "Dallas-Fort Worth Intl",   32.8998, -97.0403, "fwd"),
...
SERIES_TO_STATION: dict[str, str] = {
    "KXHIGHAUS":  "CLIAUS",
    "KXLOWTAUS":  "CLIAUS",
    # Revue 2026-09-09 : les règles Kalshi disent « Chicago Midway » et
    # « Houston-Hobby » (pas O'Hare / Intercontinental). Dallas : aucun CLI
    # n'existe pour Love Field (KDAL), le produit NWS est CLIDFW.
    "KXHIGHCHI":  "CLIMDW",
    "KXHIGHTCHI": "CLIMDW",
    "KXLOWTCHI":  "CLIMDW",
    "KXHIGHTHOU": "CLIHOU",
...
_NAME_TO_STATION: dict[str, str] = {
    ...
    "houston-hobby":    "CLIHOU",
    "houston hobby":    "CLIHOU",
    "hobby":            "CLIHOU",
    "dallas-fort worth": "CLIDFW",
    "dallas fort worth": "CLIDFW",
    "dfw":              "CLIDFW",
